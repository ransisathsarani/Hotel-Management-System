...
function CalcTotalBill(){
	...
	var waterStatus = document.getElementById("waterStatus").value;
	waterStatus = parseInt(waterStatus);
	var tel_1 = document.getElementById("tel_1").value;
	tel_1= parseFloat(tel_1);
	var tel_1Status = document.getElementById("tel_1Status").value;
	tel_1Status = parseInt(tel_1Status);
	var tel_2 = document.getElementById("tel_2").value;
	tel_2= parseFloat(tel_2);
	var tel_2Status = document.getElementById("tel_2Status").value;
	tel_2Status = parseInt(tel_2Status);
	var electricity = document.getElementById("electricity").value;
	electricity= parseFloat(electricity);
	var elecStatus = document.getElementById("elecStatus").value;
	elecStatus = parseInt(elecStatus);
	var satellite = document.getElementById("satellite").value;
	satellite= parseFloat(satellite);
	var satStatus = document.getElementById("satStatus").value;
	satStatus = parseInt(satStatus);
	...
	if((waterStatus == 1) && (tel_1Status == 1) && (tel_2Status == 1) && (elecStatus == 1) && (satStatus == 1)){
		total = water + tel_1 + tel_2 + electricity + satellite;
		
	}
	if((waterStatus == 1) && (tel_1Status == 1) && (tel_2Status == 1) && (elecStatus == 1)){
		total = water + tel_1 + tel_2 + electricity;
		
	}
	if((waterStatus == 1) && (tel_1Status == 1) && (tel_2Status == 1)){
		total = water + tel_1 + tel_2;
		
	}
	if((waterStatus == 1) && (tel_1Status == 1)){
		total = water + tel_1;
...
<div class="container-fluid bg-3 text-left" style="background-color:#d2a679;width:500px;height:800px">    
 <div class="form-group">
    ...
    <div class="form-group col-md-6">
     ...
     <select class="form-control"  id="waterStatus" name="waterStatus">
    ...
    <div class="form-group col-md-6">
     <label>Pay status:</label>
     <select class="form-control" id="tel_1Status" name="tel_1Status">
     <option value="1">Paid</option>
     <option value="0">Not paid</option>
     </select>
    </div>
    ...
    <div class="form-group col-md-6">
     <label>Pay status:</label>
     <select class="form-control"  id="tel_2Status" name="tel_2Status">
     <option value="1">Paid</option>
     <option value="0">Not paid</option>
     </select>
    </div>
    ...
    <div class="form-group col-md-6">
     <label>Pay status:</label>
     <select class="form-control" id="elecStatus" name="elecStatus">
     <option value="1">Paid</option>
     <option value="0">Not paid</option>
     </select>
    </div>
    ...
    <div class="form-group col-md-6">
     <label>Pay status:</label>
     <select class="form-control" id="satStatus" name="satStatus">
     <option value="1">Paid</option>
     <option value="0">Not paid</option>
     </select>
    </div>
