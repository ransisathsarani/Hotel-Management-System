...
<body>
	...
	<div style="background:url(images/hotel_staff_1.jpg)repeat;width:100%">
		<form method="GET" action="DepartmentAllocationServlet">
			<center>
				<legend>Department Allocation</legend>
			</center>
			...
			<div class="container-fluid bg-3 text-left"
				...
				<div class="form-group">
					<label>Qualifications:</label> <input type="text" class="form-control"
						placeholder="Enter the qualifications" name="qualifications">
				</div>
				<div class="form-group">
					<label>Department ID:</label> <input type="text" class="form-control"
						placeholder="Enter department ID" name="d_id">
				</div>
				<div class="form-group">
					<label>Department Name:</label> <input type="text"
						class="form-control" placeholder="Enter departnment name" name="d_name">
				</div>

<div class="form-group">
					<label>Contact Number:</label> <input type="text" class="form-control"
						placeholder="Enter employee contact number" name="emp_contact">
				</div>
