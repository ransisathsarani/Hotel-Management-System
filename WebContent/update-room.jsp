      ...
      <ul class="nav navbar-nav">
       ...
       <li class="dropdown">
		...
		<form action="RoomControllerServlet" method="GET">
			...
			<input type="hidden" name="roomId" value="${THE_ROOM.id}" />
			
			<div class="container-fluid bg-3 text-left" style="background-color:#ffc299;width:550px;height:800px">
				
					<div class="form-group">
						<label>Room ID:</label>
						<input type="text" class="form-control" name="RID" value="${THE_ROOM.RID}" required>
					</div>
					
					<div class="form-group">
						<label>Category:</label>
						<input type="text" class="form-control" name="category" value="${THE_ROOM.category}" required/>
					</div>
					
					<div class="form-group">
						<label>Price:</label>
						<input type="text" class="form-control" name="price" value="${THE_ROOM.price}" required/>
					</div>
					<div class="form-group">
					
						<label>Status:</label>
						<input type="text" class="form-control" name="status" value="${THE_ROOM.status}" required/>
					</div>
		...
		<p>
			<a href="RoomControllerServlet">Back to List</a>
		</p>
		 </div>
