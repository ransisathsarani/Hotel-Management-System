...
<title>Search Employee - Kanneliya Forest Resort</title>
...
<body>
	...
	<div class="container">
	 ...
	 <form method="GET" action="SalaryControllerServlet">
 			<input type="hidden" name="command" value="LOAD_SALARY" />
 			   
			<div class="container-fluid bg-3 text-left" style="width:100%;height:100%"> <!-- background-color:#6393B9; -->   
				<div class="form-group">
					...
					<div align="center">
					 ...
					 <br>
      				...
      				<input type="text" class="form-control" placeholder="E####" name="empId" required>
    			</div>
